...
const NAV = [
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        <path
          d="M1 14c0-3.31 2.91-6 6.5-6S14 10.69 14 14"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M7.5 1l2 4 4.5.5-3.3 3 .9 4.5-4.1-2.3L3.4 13l.9-4.5L1 5.5 5.5 5z"
          stroke="currentColor"
          strokeWidth="1.2"
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M2 4.5A2.5 2.5 0 014.5 2h6A2.5 2.5 0 0113 4.5v6a2.5 2.5 0 01-2.5 2.5h-6A2.5 2.5 0 012 10.5z"
          stroke="currentColor"
          strokeWidth="1.3"
        />
        <path
          d="M5 7.5l1.5 1.5L10 5.5"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M2 3.5h11a1 1 0 011 1v6a1 1 0 01-1 1H5l-3 2.5v-2.5a1 1 0 01-1-1v-6a1 1 0 011-1z"
          stroke="currentColor"
          strokeWidth="1.3"
          strokeLinejoin="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        ...
        />
        <path
          d="M7.5 1v2M7.5 12v2M14 7.5h-2M3 7.5H1M12 3l-1.5 1.5M4.5 10.5L3 12M12 12l-1.5-1.5M4.5 4.5L3 3"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none">
        <path
          d="M1 5.5h13M3 2h9a1.5 1.5 0 011.5 1.5v8A1.5 1.5 0 0112 13H3a1.5 1.5 0 01-1.5-1.5v-8A1.5 1.5 0 013 2z"
          stroke="currentColor"
          strokeWidth="1.3"
        />
        <path
          d="M4.5 8.5l1.5 1.5 3-3"
          stroke="currentColor"
          strokeWidth="1.2"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  const SidebarBody = (
    <>
      <div className="h-14 border-b border-warm-wood flex items-center px-5 gap-2 shrink-0">
        <div className="w-6 h-6 rounded-md bg-royal-gold/20 border border-royal-gold/40 flex items-center justify-center">
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            <path
              d="M6 1l1 3h3l-2.5 2 1 3L6 7.5 3.5 9l1-3L2 4h3z"
              fill="currentColor"
              className="text-royal-gold"
            />
          </svg>
        </div>
        <span className="font-display text-xs font-bold tracking-[0.1em] text-royal-gold uppercase">
          Admin
        </span>
      </div>
      <nav className="flex-1 p-2 overflow-y-auto">
        {NAV.map(({ href, label, icon }) => {
          ...
          return (
            ...
            >
              <span
                className={active ? "text-emerald-glow" : "text-soft-gray-dark"}
              >
                {icon}
              </span>
              {label}
      ...
      <div className="p-3 border-t border-warm-wood shrink-0">
        <Link
          href="/"
          className="flex items-center gap-2 text-soft-gray-dark text-xs font-ui hover:text-soft-gray transition-colors"
        >
          <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
            <path
              d="M8 1L3 6l5 5"
    ...
    <div className="min-h-screen bg-deep-void flex">
      ...
      {drawerOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          <div
            className="absolute inset-0 bg-deep-void/70"
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-auto min-w-0">
        <header className="h-14 border-b border-warm-wood bg-rich-wood-dark/80 flex justify-between items-center px-4 sm:px-6 gap-3 sticky top-0 z-30">
          <div className="flex gap-3 items-center">
            <button
              onClick={() => setDrawerOpen(true)}
              className="lg:hidden text-soft-gray hover:text-parchment-light"
            ...
            <span className="text-parchment-mid text-sm font-ui truncate">
              ...
              <span className="ml-2 text-2xs bg-crimson-ghost border border-royal-gold/30 text-royal-gold px-1.5 py-0.5 rounded-full">
                Admin
              </span>
            </span>
          </div>
