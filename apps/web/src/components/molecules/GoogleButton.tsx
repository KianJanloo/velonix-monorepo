  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-3">
        ...
        <span className="text-2xs text-soft-gray-dark font-ui uppercase tracking-wider">or</span>
        <div className="flex-1 h-px bg-warm-wood" />
      </div>
      <button
        type="button"
        onClick={loginWithGoogle}
        className="w-full flex items-center justify-center gap-3 py-2.5 rounded-lg border border-warm-wood-light bg-rich-wood-mid text-parchment-light font-ui font-semibold text-sm hover:border-parchment-mid hover:bg-warm-wood transition-all"
      >
