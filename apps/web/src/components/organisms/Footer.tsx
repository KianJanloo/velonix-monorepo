      ...
      <div className="max-w-7xl mx-auto px-6 py-14">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-10 mb-14">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-soft-gray text-sm font-ui leading-relaxed max-w-[220px]">
              The premium platform for designing and publishing digital board games.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-5">
            <a href="#" aria-label="Twitter / X" className="text-soft-gray-dark hover:text-parchment-light transition-colors">
            ...
            <a href="#" aria-label="Discord" className="text-soft-gray-dark hover:text-parchment-light transition-colors">
            ...
            <a href="#" aria-label="GitHub" className="text-soft-gray-dark hover:text-parchment-light transition-colors">
              <svg width="17" height="17" viewBox="0 0 24 24" fill="currentColor">
